...
?>
    ...
    <main role="main" class="container">
        <div class="jumbotron">
            <h1 class="text-center">Your score was <?php echo $score; ?>%</h1></br></br>
            <p class="text-center"><?php echo $message; ?></p></br></br>

            <p class="text-center"><a class="btn btn-primary" href="?link=UserResults" role="button">See my results</a></p>
